...
mercado. De acordo com Sugomori (2016) empresas de tecnologia, como Google e
...
si própria''(p.16). Ao contrário dos algoritmos tradicionais, os algoritmos de
...
finalidade é a modulação (Deleuze, 1992, 226).
...
história política" (Domingos, 2017, 41). Ele reuniu todas as informações sobre eleitores em
...
ideias sobre um assunto especifico'' (Ibid.). Com base nesse modelo, a campanha
...
As eleições de Barack Obama, em 2012 e Donald Trump, em 2016, são exemplos 
de utilização do Aprendizado de Máquina como dispositivo de modulação 
para fins políticos.
